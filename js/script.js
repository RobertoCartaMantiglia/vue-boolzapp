...
// vengono visualizzati solo i contatti il cui nome contiene le lettere 
...
createApp({
    ...
    methods: {
        ...
        serchContact(newSerchInput) {
            this.contacts.forEach(contact => {
                if (contact.name.toLowerCase().includes(newSerchInput.toLowerCase())) {
